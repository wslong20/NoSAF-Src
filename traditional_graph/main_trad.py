...
from models import NoSAFGCN, DeepNoSAFGCN
from utils.utils import get_dataset
# from models.exp_model import ADNGCN, ADNGCNAccRes, ADNGSage, ADNGSageAccRes
...
def main():
    ...
    # dataset settings
    parser.add_argument('--dataset_dir', type=str, default="./data/homophily")
    ...
    # backbone settings
    parser.add_argument('--gnn_conv', type=str, default="gcn", choices=["gcn"])
    ...
    if args.gnn_conv == "gcn":
        if not args.use_acc_res:
            model = NoSAFGCN(in_features=data.num_features,
            ...
            model = DeepNoSAFGCN(in_features=data.num_features,
                                 gnn_in_features=args.gnn_in_features,
                                 out_features=dataset.num_classes,
                                 input_map_numlayer=args.input_map_numlayer,
                                 backbone_numlayer=args.backbone_numlayer,
